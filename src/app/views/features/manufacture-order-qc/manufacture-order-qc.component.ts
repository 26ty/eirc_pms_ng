...
@Component({
  selector: 'app-manufacture-order-qc',
  templateUrl: './manufacture-order-qc.component.html',
  styleUrls: ['./manufacture-order-qc.component.scss']
})
export class ManufactureOrderQcComponent implements OnInit {
