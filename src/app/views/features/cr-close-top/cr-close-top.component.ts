...
@Component({
  selector: 'app-cr-close-top',
  templateUrl: './cr-close-top.component.html',
  styleUrls: ['./cr-close-top.component.scss']
})
export class CrCloseTopComponent implements OnInit {
  ...
  getCrReturnList_L(account: any, userId: any): void {
    ...
    this.HttpApiService.getTopCloseCloseCrReturnList(account, userId).subscribe(res => {
      ...
      this.showData(this.userCrReturnData_L.body)
    })
  }
