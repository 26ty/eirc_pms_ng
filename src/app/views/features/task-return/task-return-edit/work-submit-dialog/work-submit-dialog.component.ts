...
export class WorkSubmitDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // if(this.month >9){
    //   this.labor_date = new Date(`${year}-${this.month}-${this.day}`)
    // }else{
    //   this.labor_date = new Date(`${year}-0${this.month}-${this.day}`)
    // }
    this.labor_date = new Date(`${this.year}-${this.month}-${this.day}`)
    console.log(this.labor_date) //工時表日期

    // if(this.month>9)
    // var test = new Date("2021-05-3");
    // console.log(test)
    ...
    //   this.date_for_start = this.labor_date
    //   // this.getTaskRequestByOriginId() //選項陣列函式
    ...
    // if(this.t_id){
    //   this.origin_id =='1e6913f5-55be-413a-94a5-68f8cc67d5b2'
    // }
