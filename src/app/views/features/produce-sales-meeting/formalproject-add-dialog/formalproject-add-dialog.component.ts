...
@Component({
  selector: 'app-formalproject-add-dialog',
  templateUrl: './formalproject-add-dialog.component.html',
  styleUrls: ['./formalproject-add-dialog.component.scss']
})
export class FormalprojectAddDialogComponent implements OnInit {
