...
@Component({
  selector: 'app-cr-close-prodution-edit',
  templateUrl: './cr-close-prodution-edit.component.html',
  styleUrls: ['./cr-close-prodution-edit.component.scss']
})
export class CrCloseProdutionEditComponent implements OnInit {
