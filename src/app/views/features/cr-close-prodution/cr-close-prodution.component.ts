...
@Component({
  selector: 'app-cr-close-prodution',
  templateUrl: './cr-close-prodution.component.html',
  styleUrls: ['./cr-close-prodution.component.scss']
})

export class CrCloseProdutionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //獲取使用者可執行的單
    this.getCrReturnList(this.userJson.account, this.userJson.bonita_user_id)
  }
  ...
  crRerurnTotal_N: any
  //獲取使用者可執行的單
  getCrReturnList(account: any, userId: any): void {
