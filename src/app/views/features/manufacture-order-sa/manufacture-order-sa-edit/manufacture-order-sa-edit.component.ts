...
@Component({
  selector: 'app-manufacture-order-sa-edit',
  templateUrl: './manufacture-order-sa-edit.component.html',
  styleUrls: ['./manufacture-order-sa-edit.component.scss']
})
export class ManufactureOrderSaEditComponent implements OnInit {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.HttpApiService.reviewManufactureForm(this.userJson.account, this.bonita_task_id, reviewData).subscribe(res => {
          console.log("res", res)
          //更新製令資料庫
          this.updateProjectInfoManufacture('收文者會簽')
          /*新增審核紀錄 */
          this.uploadTransactionRecordRequests(this.m_id, '確認單號開啟')
        ...
        Swal.fire(
          ...
          if (result.isConfirmed) {
            location.href = '/main/manufacture-order-sa'
          }
        })
