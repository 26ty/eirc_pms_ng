...
@Component({
  selector: 'app-project-infomanufacture-orderaudit',
  templateUrl: './project-infomanufacture-orderaudit.component.html',
  styleUrls: ['./project-infomanufacture-orderaudit.component.scss']
})
export class ProjectInfomanufactureOrderauditComponent implements OnInit {
  ...
  getManufactureReturnRequest(account: any, userId: any): void {
    ...
    this.HttpApiService.getManufactureReturnList(account, userId).subscribe(res => {
      ...
      this.showData(this.userMReturnData.body)
    })
  }
  // 顯示資料
  showData(data: any) {
