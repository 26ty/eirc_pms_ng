...
@Component({
  selector: 'app-project-infomanufacture-orderaudit-edit',
  templateUrl: './project-infomanufacture-orderaudit-edit.component.html',
  styleUrls: ['./project-infomanufacture-orderaudit-edit.component.scss']
})
export class ProjectInfomanufactureOrderauditEditComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getManufactureReturnRequest(this.userJson.account, this.userJson.bonita_user_id)
    //取得部門資料
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.HttpApiService.reviewManufactureForm(this.userJson.account, this.bonita_task_id, reviewData).subscribe(res => {
          ...
          console.log("res", res)
          //更新製令資料庫
          this.updateProjectInfoManufacture('生管確認中')
          /*新增審核紀錄 */
          this.uploadTransactionRecordRequests(this.m_id, '單位主管審核')
        ...
        Swal.fire(
          ...
          if (result.isConfirmed) {
            location.href = '/main/project-C/project-infomanufacture-orderaudit'
          }
        })
